...
void put_chinese_char16(int x, int y, int c, uint32_t colidx);
void put_chinese_char32(int x, int y, int c, uint32_t colidx);
void put_chinese_char80(int x, int y, int m, uint32_t colidx);
...
UG_RESULT UG_TextboxSetText( UG_WINDOW* wnd, UG_U8 id, unsigned char* str );
